...
import {Mail, MapPin, Github, Linkedin , Twitter, Heart, Facebook, Dribbble } from 'lucide-react';
    ...
    <footer className="relative bg-black overflow-hidden border-t border-white/10">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <FadeIn delay={100}>
            <div>
              <h4 className="text-white font-semibold mb-6 text-lg">QuickLink</h4>
          ...
          <div className="pt-8 border-t border-white/10">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <p className="flex items-center gap-2 text-white/50 text-sm">
                Build with <Heart className="w-4 h-4 text-primary fill-primary animate-pulse" /> using React & Tailwind.
              </p>
            </div>
          </div>
        </FadeIn>
