...
import { Download, Code2, Sparkle, Code } from "lucide-react";
import {SiReact, SiNextdotjs, SiTypescript, SiTailwindcss, SiMongodb, SiMysql} from "react-icons/si";
...
const About = () => {
    ...
    // Skills
    const skills = [
        {  name: "React", icon: SiReact, level: 88, experience: 2,  color: "#61DAFB" },
        {  name: "Next.js", icon: SiNextdotjs, level: 85, experience: 1, color: "#000000" },
        {  name: "TailwindCSS", icon: SiTailwindcss, level: 80, experience: 2, color: "#06B6D4" },
        {  name: "MongoDB", icon: SiMongodb, level: 80, experience: 1, color: "#47A248" },
        {  name: "TypeScript", icon: SiTypescript, level: 82, experience: 1, color: "#3178C6" },
        {  name: "MySql", icon: SiMysql, level: 82, experience: 1, color: "#3178C6" },
        
        
      ];
  return <section id="about" className="relative py-16 px-4 sm:px-6 lg:px-8 bg-black overflow-x-hidden">
        <RadialGradientBackground variant="about" />
        
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-4 lg:px-8">
            {/* Main Grid */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center mb-20">
                ...
                <div className="flex flex-col gap-12">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                            {ABOUT_STATS.map((stat, index) => (
                                <div key={index} className="relative">
                                    ...
                                    <div className="text-3xl font-normal text-white mb-2 font-moto">
                                        {stat.value}
                                    </div>
                    ...
                    <FadeIn delay={400}>
                        <button
                            ...
                            className="inline-flex items-center gap-3 bg-white hover:bg-white/90 text-black rounded-full px-6 py-3 sm:px-8 sm:py-4 text-base font-medium transition-all duration-300 w-fit group"
                        >
                ...
                <FadeIn delay={200}>
                    <div className="grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6">
                            ...
                            <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300">
                                <div className="flex items-start gap-4">
                                    <div className="p-3 bg-primary/10 rounded-xl w-fit mb-4">
                                        <Code2 className="w-5 h-6 text-primary" />
                                    </div>
                        ...
                        <div className="relative group">
                            ...
                            <div className = "relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300">
                                <div className="p-3 bg-primary/10 rounded-xl w-fit mb-4">
                                    <Sparkle className="w-5 h-6 text-primary" />
                                </div>
                        ...
                        <div className="relative group ">
                            ...
                            <div className = "relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300">
                                <div className="p-3 bg-primary/10 rounded-xl w-fit mb-4">
                                    <Download className="w-5 h-6 text-primary" />
                                </div>
                ...
                <div className="flex flex-col items-center gap-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 w-full max-w-4xl">
                        {skills.map((skill, index) => (
                            ...
                            >
                                <skill.icon className="text-2xl sm:text-3xl text-primary" />
